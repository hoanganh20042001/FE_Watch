...
export default function CategorysAdminPage() {
    return <>

            <NavAdmin />
            <Grid columns={12} style={{ marginTop: '20px' }}>
                <Grid.Col style={{ paddingTop: '50px'}} xs={12} sm={3}><Sidebar selected={7} /></Grid.Col>
                <Grid.Col style={{ padding: 0 }} xs={12} sm={9}> <Categorys /></Grid.Col>
            </Grid >
